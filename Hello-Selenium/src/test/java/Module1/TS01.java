...
public class TS01 {
	...
	public void test001(){
		System.out.println("Excecuting test001 of TS01- Module 1");
	}
	
	@Test(groups = {"smoke"})
	public void test002(){
		System.out.println("Excecuting test002 of TS01- Module 1");
	}
	
	@Test
	public void test003(){
		System.out.println("Excecuting test003 of TS01- Module 1");
	}
